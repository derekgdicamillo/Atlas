...
- 2026-09-05: Post-compact re-orientation failure class confirmed fixed (post-compact v2 hook landed Aug 26; 3 consecutive /reflect windows Sep 2-4 all show 0x violations — this failure was written into behavioral-fixes.md 20+ times and never fixed with advisory rules alone; structural enforcement resolved it)
