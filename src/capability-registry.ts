...
const ALL_CAPABILITIES: CapabilityDeclaration[] = [
  ...
  },
  {
    ...
    can: [
      ...
      "PV Knowledge Layer integration: every Opus/Sonnet prompt (hooks, recon, monthly, GBP) loads canonical voice guide, humanizer rules, anti-patterns, 4 avatars (Linda/Mike/Maggie/Sophie), Schwartz awareness stages, objections-fears-desires, 55-hook library, 9 Derek-named frameworks, and competitive synthesis from PV-Knowledge-Layer git repo. focus parameter selects relevant subset per call",
      "nightly 3:45 AM git pull + re-ingest of PV-Knowledge-Layer (cron: pv-knowledge-pull). SHA-256 dedup means only changed files re-process",
    ],
    cannot: [
      ...
      "load knowledge layer if PV-Knowledge-Layer repo not cloned (degrades gracefully — Midas falls back to inline business-bible.md)",
    ],
    ...
    notes: "Agent file: .claude/agents/marketing.md (Opus). Knowledge base: memory/marketing/ + PV-Knowledge-Layer git repo (canonical). Frameworks: Hormozi Value Equation, Brunson Hook-Story-Offer, Meta Andromeda Entity IDs, plus 9 Derek-named frameworks (5 Pillars / Vitality Tracker / Protein Paradox / Fuel Code / Calm Core / etc.) loaded via loadKnowledgeContext().",
    module: "src/marketing.ts, src/ingest-worker.ts, scripts/ingest-knowledge-layer.ts",
  },
  {
